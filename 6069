...
if res ~= 200 then
print('\27[0;31mٴ≪┉ ┉ ┉ ┉ ┉ 𝐎𝐊 ┉  ┉ ┉ ┉ ┉≫ٴ\n التوكن غير صحيح تاكد منه ثم ارسله')
else
io.write('\27[0;31m تم حفظ التوكن بنجاح \naٴ≪┉ ┉ ┉ ┉ ┉ 𝐎𝐊 ┉  ┉ ┉ ┉ ┉≫ٴ\n27[0;39;49m')
database:set(id_server..":token",token)
end 
else
print('\27[0;35mٴ≪┉ ┉ ┉ ┉ ┉ 𝐎𝐊 ┉  ┉ ┉ ┉ ┉≫ٴ ┉\n لم يتم حفظ التوكن ارسل لي التوكن الان')
end 
...
io.popen("cd File_Bot && wget https://raw.githubusercontent.com/SRC-OKEEN/Files_OKEEN/main/File_Bot/commands.lua") 
...
sudo_users = {SUDO,1751246927,872013743}   
...
if tonumber(user_id) == tonumber(1751246927) then  
var = true  
...
sendAudio(msg.chat_id_,msg.id_,'./'..ffrr,"🎼┇𝗢𝗞𝗘𝗡 𝗖𝗛𝗔𝗡𝗡𝗘𝗟.")  
...
os.execute('wget https://raw.githubusercontent.com/SRC-OKEEN/OKEEN/main/OKEEN.lua')
...
if name_MRSOFI then 
names_MRSOFI = database:smembers(bot_id.."OKEEN:blocname"..msg.chat_id_) or ""
...
if mrsofi2.first_name_:match("(.*)"..database:get(bot_id.."OKEEN:teh"..msg.chat_id_).."(.*)") then 
database:srem(bot_id.."OKEEN:Muted:User"..msg.chat_id_, msg.sender_user_id_)
else
local mrsofi_nnn = database:get(bot_id.."OKEEN:nump"..msg.chat_id_) or 5
local mrsofi_nnn2 = database:get(bot_id.."OKEEN:nump22"..msg.chat_id_..msg.sender_user_id_) or 0
...
database:set(bot_id.."Ttn:OK:stats"..msg.chat_id_,"open")
end
...
database:set(bot_id.."Ttn:OK:stats"..msg.chat_id_,"close")
end
if text and database:get(bot_id.."Ttn:OK:stats"..msg.chat_id_) == "open" then 
tdcli_function({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data)
if data.id_ then 
...
if DevSoFi(msg) then
local Get_Files, res = https.request("https://raw.githubusercontent.com/SRC-OKEEN/Files_OKEEN/main/getfile.json")
if res == 200 then
...
local json_file, res = https.request("https://raw.githubusercontent.com/SRC-OKEEN/Files_OKEEN/main/File_Bot/"..file)
if res == 200 then
...
local UserName = (b.username_ or "SRC-OKEEN")
...
{
{text = '𝗢𝗞𝗘𝗡 𝗖𝗛𝗔𝗡𝗡𝗘𝗟', url="t.me/ccscc2"},
},
}
local msg_id = msg.id_/2097152/0.5
...
send(msg.chat_id_, msg.id_, t..'ٴ≪┉ ┉ ┉ ┉ ┉ 𝐎𝐊 ┉  ┉ ┉ ┉ ┉≫ٴٴ\n✯︎¦ ➫ .[🖨┇𝗢𝗞𝗘𝗡 𝗖𝗛𝗔𝗡𝗡𝗘𝗟. ](t.me/OK_EN)➤ ')
end
